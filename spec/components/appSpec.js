...
describe('app', function() {
  ...
  it('should have a video property on the scope', function() {
    expect(element.isolateScope().$ctrl.video).to.exist;
    expect(element.isolateScope().$ctrl.video).to.be.a('object');
  });
